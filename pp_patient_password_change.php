...
<html>
    ...
    <body>
        <div class="reg-container reg-popup" id="patientpasswordchange">
            <img src="img/Close_Cross_Icon.png" onclick="togglepatientpasswordchangepopup();"/>
            <p>Change Password</p>
            <form method="post" action="action/pp_patient_password_changer.php">
                <input type="hidden" name="id" id="id" value="<?php echo $activePatientId; ?>" placeholder="Patientistrator Id" readonly/>
