...
<html>
    ...
    <body>
        <div class="reg-container reg-popup" id="doctorpasswordchange">
            <img src="img/Close_Cross_Icon.png" onclick="toggledoctorpasswordchangepopup();"/>
            <p>Change Password</p>
            <form method="post" action="action/dd_doctor_password_changer.php">
                <input type="hidden" name="id" id="id" value="<?php echo $activeDoctorId; ?>" placeholder="Doctoristrator Id" readonly/>
